...
//  GiftManager
//
//  Created by David Johnson on 11/8/16.
...
class AppDelegate: NSObject, NSApplicationDelegate
{
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification)
    {
        ...
        AppContext.managedObjectContext = self.managedObjectContext
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "GiftManager", withExtension: "momd")!
