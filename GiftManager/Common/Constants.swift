...
/// A class to contain constants used throughout the application.
class Constants {
	
	/// The button color for all ok buttons
	static let Color_Button_OK = NSColor(red:0.35, green:0.61, blue:0.35, alpha:1.00)
